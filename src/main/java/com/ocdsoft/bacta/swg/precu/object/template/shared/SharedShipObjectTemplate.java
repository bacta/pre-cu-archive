...
public class SharedShipObjectTemplate extends SharedTangibleObjectTemplate {
    private static final int TAG_SHAREDSHIPOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedShipObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
