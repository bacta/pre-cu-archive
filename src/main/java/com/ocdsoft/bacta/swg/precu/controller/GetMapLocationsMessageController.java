...
@SwgController(server = ServerType.GAME, handles = GetMapLocationsMessage.class)
public class GetMapLocationsMessageController implements SwgMessageController<GameClient> {
