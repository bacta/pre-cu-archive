...
public class ServerCityObjectTemplate extends ServerUniverseObjectTemplate {
    private static final int TAG_SERVERCITYOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerCityObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
