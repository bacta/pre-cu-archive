...
public class SharedWaypointObjectTemplate extends SharedIntangibleObjectTemplate {
    private static final int TAG_SHAREDWAYPOINTOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedWaypointObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
