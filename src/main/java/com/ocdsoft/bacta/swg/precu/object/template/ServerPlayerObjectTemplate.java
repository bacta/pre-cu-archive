...
public class ServerPlayerObjectTemplate extends ServerIntangibleObjectTemplate {
    private static final int TAG_SERVERPLAYEROBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerPlayerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
