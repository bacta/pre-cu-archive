...
public class SharedTangibleObjectTemplate extends SharedObjectTemplate {
    private static final int TAG_SHAREDTANGIBLEOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedTangibleObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
    ...
    protected static class RangedIntCustomizationVariableObjectTemplate extends ObjectTemplate {
        private static final int TAG_RANGEDINTCUSTOMIZATIONVARIABLE = Tag.convertStringToTag("RICV");

        public RangedIntCustomizationVariableObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
    ...
    protected static class PaletteColorCustomizationVariableObjectTemplate extends ObjectTemplate {
        private static final int TAG_PALETTECOLORCUSTOMIZATIONVARIABLE = Tag.convertStringToTag("PCCV");

        public PaletteColorCustomizationVariableObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
    ...
    protected static class ConstStringCustomizationVariableObjectTemplate extends ObjectTemplate {
        private static final int TAG_CONSTSTRINGCUSTOMIZATIONVARIABLE = Tag.convertStringToTag("CSCV");

        public ConstStringCustomizationVariableObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
    ...
    protected static class CustomizationVariableMappingObjectTemplate extends ObjectTemplate {
        private static final int TAG_CUSTOMIZATIONVARIABLEMAPPING = Tag.convertStringToTag("CVMM");

        public CustomizationVariableMappingObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
