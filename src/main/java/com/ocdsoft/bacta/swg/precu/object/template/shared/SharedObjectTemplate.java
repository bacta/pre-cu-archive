...
public class SharedObjectTemplate extends ObjectTemplate {
    private static final int TAG_SHAREDOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
