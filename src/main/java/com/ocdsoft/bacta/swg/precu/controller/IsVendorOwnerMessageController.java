...
@SwgController(server=ServerType.GAME, handles=IsVendorOwnerMessage.class)
public class IsVendorOwnerMessageController implements SwgMessageController<GameClient> {
