...
public class ServerObjectTemplate extends ObjectTemplate {
    private static final int TAG_SERVEROBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public ServerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
    ...
    public static class AttribMod {
        @Getter
        protected Attributes target;
        @Getter
        protected int value;
        @Getter
        protected float time;
        @Getter
        protected float timeAtValue;
        @Getter
        protected float decay;
    }

    protected static class AttribModObjectTemplate extends ObjectTemplate {
        private static final int TAG_ATTRIBMOD = Tag.convertStringToTag("ATTS");

        public AttribModObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
    ...
    protected static class MentalStateModObjectTemplate extends ObjectTemplate {
        private static final int TAG_MENTALSTATEMOD = Tag.convertStringToTag("MESM");

        public MentalStateModObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
    ...
    public static class Contents {
        ...
        @Getter
        protected boolean equipObject;
        @Getter
        protected ObjectTemplate content;
    }

    protected static class ContentsObjectTemplate extends ObjectTemplate {
        private static final int TAG_CONTENTS = Tag.convertStringToTag("CONT");

        public ContentsObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
    ...
    protected static class XpObjectTemplate extends ObjectTemplate {
        private static final int TAG_XP = Tag.convertStringToTag("EXPS");

        public XpObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
            super(filename, objectTemplateList);
        }
