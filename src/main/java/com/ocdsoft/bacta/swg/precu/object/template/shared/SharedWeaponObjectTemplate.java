...
public class SharedWeaponObjectTemplate extends SharedTangibleObjectTemplate {
    private static final int TAG_SHAREDWEAPONOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedWeaponObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
        super(filename, objectTemplateList);
    }

    @Override
    public int getId() {
        return TAG_SHAREDWEAPONOBJECTTEMPLATE;
    }
