...
@SwgController(server = ServerType.GAME, handles = NewTicketActivityMessage.class)
public class NewTicketActivityMessageController implements SwgMessageController<GameClient> {
