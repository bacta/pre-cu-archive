...
public class ServerManufactureInstallationObjectTemplate extends ServerInstallationObjectTemplate {
    private static final int TAG_SERVERMANUFACTUREINSTALLATIONOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerManufactureInstallationObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
