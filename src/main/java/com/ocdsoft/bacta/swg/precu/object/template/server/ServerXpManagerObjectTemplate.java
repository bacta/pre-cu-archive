...
public class ServerXpManagerObjectTemplate extends ServerUniverseObjectTemplate {
    private static final int TAG_SERVERXPMANAGEROBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerXpManagerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
