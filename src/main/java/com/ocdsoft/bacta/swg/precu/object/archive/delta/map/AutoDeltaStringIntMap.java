...
public class AutoDeltaStringIntMap extends AutoDeltaContainer {
    private transient final List<Command> changes;
    private final TObjectIntMap<String> container;
    private transient int baselineCommandCount;

    public AutoDeltaStringIntMap() {
        this.changes = new ArrayList<>(5);
        this.container = new TObjectIntHashMap<String>();
    ...
    public TObjectIntMap<String> getMap() {
        return container;
    }
    ...
    private void onErase(final String key, final int value) {
        //callback
    }

    private void onInsert(final String key, final int value) {
        //callback
    }

    private void onSet(final String key, final int oldValue, final int newValue) {
        //callback
    }
    ...
    public final class Command implements ByteBufferWritable {
        ...
        public Command(int cmd, String key, int value) {
            this.cmd = (byte) cmd;
            this.key = key;
            this.value = value;
        }
