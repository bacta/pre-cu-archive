...
public class ServerBuildingObjectTemplate extends ServerTangibleObjectTemplate {
    private static final int TAG_SERVERBUILDINGOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public ServerBuildingObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
