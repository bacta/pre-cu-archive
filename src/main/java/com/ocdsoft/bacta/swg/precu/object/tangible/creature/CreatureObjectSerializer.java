...
import com.ocdsoft.bacta.swg.server.game.object.tangible.TangibleObjectSerializer;
 ...
 */
public class CreatureObjectSerializer<T extends CreatureObject> extends TangibleObjectSerializer<T> {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Inject
    public CreatureObjectSerializer(ObjectService objectService,
