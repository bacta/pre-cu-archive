...
public class AutoDeltaStringLongMap extends AutoDeltaContainer {
    private transient final List<Command> changes;
    private final TObjectLongMap<String> container;
    private transient int baselineCommandCount;

    public AutoDeltaStringLongMap() {
        this.changes = new ArrayList<>(5);
        this.container = new TObjectLongHashMap<String>();
    ...
    public TObjectLongMap<String> getMap() {
        return container;
    }
    ...
    private void onErase(final String key, final long value) {
        //callback
    }

    private void onInsert(final String key, final long value) {
        //callback
    }

    private void onSet(final String key, final long oldValue, final long newValue) {
        //callback
    }
    ...
    public final class Command implements ByteBufferWritable {
        ...
        public Command(int cmd, String key, long value) {
            this.cmd = (byte) cmd;
            this.key = key;
            this.value = value;
        }
