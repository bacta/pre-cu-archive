...
public class ServerGroupObjectTemplate extends ServerUniverseObjectTemplate {
    private static final int TAG_SERVERGROUPOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerGroupObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
