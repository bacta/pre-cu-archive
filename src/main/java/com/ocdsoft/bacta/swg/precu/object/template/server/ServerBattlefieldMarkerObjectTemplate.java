...
public class ServerBattlefieldMarkerObjectTemplate extends ServerTangibleObjectTemplate {
    private static final int TAG_SERVERBATTLEFIELDMARKEROBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerBattlefieldMarkerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
