...
public class ServerUniverseObjectTemplate extends ServerObjectTemplate {
    private static final int TAG_SERVERUNIVERSEOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerUniverseObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
