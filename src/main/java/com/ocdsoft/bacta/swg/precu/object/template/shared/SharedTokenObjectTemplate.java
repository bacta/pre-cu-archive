...
public class SharedTokenObjectTemplate extends SharedIntangibleObjectTemplate {
    private static final int TAG_SHAREDTOKENOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedTokenObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
