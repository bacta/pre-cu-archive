package com.ocdsoft.bacta.swg.precu.object.archive.delta.packedmap;

import com.ocdsoft.bacta.swg.precu.object.archive.delta.map.AutoDeltaIntFloatMap;
 ...
 * on the network.
 */
public class AutoDeltaPackedIntFloatMap extends AutoDeltaIntFloatMap {
    ...
    public static void packFromString(final ByteBuffer target, final String buffer) {
        ...
        for (final String entry : entries) {
            ...
            final float val = Float.parseFloat(entryTokens[1]);
    ...
    public static String unpackToString(final ByteBuffer source) {
        ...
        if (commandCount == 0) {
            ...
            for (int i = 0; i < commandCount; ++i) {
                ...
                sb.append(String.format("%d %.2f:", command.key, command.value));
            }
