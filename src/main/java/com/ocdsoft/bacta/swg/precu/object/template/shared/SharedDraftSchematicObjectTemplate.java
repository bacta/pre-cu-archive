...
public class SharedDraftSchematicObjectTemplate extends SharedIntangibleObjectTemplate {
    private static final int TAG_SHAREDDRAFTSCHEMATICOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedDraftSchematicObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
    ...
    protected static class IngredientSlotObjectTemplate extends ObjectTemplate {
        private static final int TAG_INGREDIENTSLOT = Tag.convertStringToTag("SISS");
    ...
    protected static class SchematicAttributeObjectTemplate extends ObjectTemplate {
        private static final int TAG_SCHEMATICATTRIBUTE = Tag.convertStringToTag("DSSA");
