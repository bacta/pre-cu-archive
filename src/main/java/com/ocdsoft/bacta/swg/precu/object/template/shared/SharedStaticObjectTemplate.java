...
public class SharedStaticObjectTemplate extends SharedObjectTemplate {
    private static final int TAG_SHAREDSTATICOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedStaticObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
