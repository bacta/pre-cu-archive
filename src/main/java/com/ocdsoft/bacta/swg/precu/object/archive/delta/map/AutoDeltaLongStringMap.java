...
public class AutoDeltaLongStringMap extends AutoDeltaContainer {
    private transient final List<Command> changes;
    private final TLongObjectMap<String> container;
    private transient int baselineCommandCount;

    public AutoDeltaLongStringMap() {
        this.changes = new ArrayList<>(5);
        this.container = new TLongObjectHashMap<String>();
    ...
    public TLongObjectMap<String> getMap() {
        return container;
    }
    ...
    private void onErase(final long key, final String value) {
        //callback
    }

    private void onInsert(final long key, final String value) {
        //callback
    }

    private void onSet(final long key, final String oldValue, final String newValue) {
        //callback
    }
    ...
    public final class Command implements ByteBufferWritable {
        ...
        public Command(int cmd, long key, String value) {
            this.cmd = (byte) cmd;
            this.key = key;
            this.value = value;
        }
