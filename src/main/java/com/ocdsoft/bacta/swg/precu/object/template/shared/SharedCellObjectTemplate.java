...
public class SharedCellObjectTemplate extends SharedObjectTemplate {
    private static final int TAG_SHAREDCELLOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedCellObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
        super(filename, objectTemplateList);
    }

    @Override
    public int getId() {
        return TAG_SHAREDCELLOBJECTTEMPLATE;
    }
