...
public class SharedBattlefieldMarkerObjectTemplate extends SharedTangibleObjectTemplate {
    private static final int TAG_SHAREDBATTLEFIELDMARKEROBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedBattlefieldMarkerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
