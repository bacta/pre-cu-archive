...
import com.ocdsoft.bacta.swg.server.game.object.intangible.IntangibleObjectSerializer;
 ...
 */
public class PlayerObjectSerializer<T extends PlayerObject> extends IntangibleObjectSerializer<T> {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Inject
    public PlayerObjectSerializer(ObjectService objectService,
