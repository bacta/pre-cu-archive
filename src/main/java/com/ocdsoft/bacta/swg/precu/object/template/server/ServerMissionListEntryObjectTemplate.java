...
public class ServerMissionListEntryObjectTemplate extends ServerIntangibleObjectTemplate {
    private static final int TAG_SERVERMISSIONLISTENTRYOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerMissionListEntryObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
