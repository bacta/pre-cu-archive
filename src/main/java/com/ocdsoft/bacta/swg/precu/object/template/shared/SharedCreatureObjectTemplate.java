...
public class SharedCreatureObjectTemplate extends SharedTangibleObjectTemplate {
    private static final int TAG_SHAREDCREATUREOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public SharedCreatureObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
