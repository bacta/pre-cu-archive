...
public class AutoDeltaStringFloatMap extends AutoDeltaContainer {
    private transient final List<Command> changes;
    private final TObjectFloatMap<String> container;
    private transient int baselineCommandCount;

    public AutoDeltaStringFloatMap() {
        this.changes = new ArrayList<>(5);
        this.container = new TObjectFloatHashMap<String>();
    ...
    public TObjectFloatMap<String> getMap() {
        return container;
    }
    ...
    private void onErase(final String key, final float value) {
        //callback
    }

    private void onInsert(final String key, final float value) {
        //callback
    }

    private void onSet(final String key, final float oldValue, final float newValue) {
        //callback
    }
    ...
    public final class Command implements ByteBufferWritable {
        ...
        public Command(int cmd, String key, float value) {
            this.cmd = (byte) cmd;
            this.key = key;
            this.value = value;
        }
