...
public class SharedPlayerObjectTemplate extends SharedIntangibleObjectTemplate {
    private static final int TAG_SHAREDPLAYEROBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedPlayerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
