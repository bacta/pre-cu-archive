...
public class SharedResourceContainerObjectTemplate extends SharedTangibleObjectTemplate {
    private static final int TAG_SHAREDRESOURCECONTAINEROBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedResourceContainerObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
