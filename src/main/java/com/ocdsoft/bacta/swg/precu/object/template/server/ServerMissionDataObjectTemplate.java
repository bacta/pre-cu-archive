...
public class ServerMissionDataObjectTemplate extends ServerIntangibleObjectTemplate {
    private static final int TAG_SERVERMISSIONDATAOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public ServerMissionDataObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
