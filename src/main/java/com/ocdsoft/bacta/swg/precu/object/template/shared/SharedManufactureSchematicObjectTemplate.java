...
public class SharedManufactureSchematicObjectTemplate extends SharedIntangibleObjectTemplate {
    private static final int TAG_SHAREDMANUFACTURESCHEMATICOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedManufactureSchematicObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
