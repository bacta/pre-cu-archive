...
public class SharedGuildObjectTemplate extends SharedUniverseObjectTemplate {
    private static final int TAG_SHAREDGUILDOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;


    public SharedGuildObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
