...
import com.ocdsoft.bacta.swg.precu.object.archive.delta.map.AutoDeltaIntLongMap;
 ...
 * on the network.
 */
public class AutoDeltaPackedIntLongMap extends AutoDeltaIntLongMap {
    ...
    public static void packFromString(final ByteBuffer target, final String buffer) {
        ...
        for (final String entry : entries) {
            ...
            final long val = Long.parseLong(entryTokens[1]);
