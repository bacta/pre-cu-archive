...
public class ServerTangibleObjectTemplate extends ServerObjectTemplate {
    private static final int TAG_SERVERTANGIBLEOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public ServerTangibleObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
