 ...
 */
@Singleton
public class PreCuContainerService implements ContainerService<SceneObject> {
    ...
    @Inject
    public PreCuContainerService(SlotIdManager slotIdManager,
    ...
    @Override
    public int getTotalVolumeLimitedByParents(SceneObject volumeContainer) {
