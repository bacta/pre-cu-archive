...
import com.ocdsoft.bacta.swg.server.game.message.auction.CommoditiesItemTypeListRequest;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@SwgController(server = ServerType.GAME, handles = CommoditiesItemTypeListRequest.class)
public class CommoditiesItemTypeListRequestController implements SwgMessageController<GameClient> {
