...
public class ServerVehicleObjectTemplate extends ServerTangibleObjectTemplate {
    private static final int TAG_SERVERVEHICLEOBJECTTEMPLATE = Tag.convertStringToTag("0000");
    ...
    public ServerVehicleObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
