...
public class ServerPlanetObjectTemplate extends ServerUniverseObjectTemplate {
    private static final int TAG_SERVERPLANETOBJECTTEMPLATE = Tag.convertStringToTag("0000");

    private int templateVersion;

    private final StringParam planetName = new StringParam(); //name of the planet

    public ServerPlanetObjectTemplate(final String filename, final ObjectTemplateList objectTemplateList) {
