...
public class AutoDeltaStringByteMap extends AutoDeltaContainer {
    ...
    private void onErase(final String key, final byte value) {
        //callback
    }

    private void onInsert(final String key, final byte value) {
        //callback
    }

    private void onSet(final String key, final byte oldValue, final byte newValue) {
        //callback
    }
    ...
    public static class Command implements ByteBufferWritable {
        ...
        public Command(int cmd, String key, byte value) {
            this.cmd = (byte) cmd;
            this.key = key;
            this.value = value;
        }
