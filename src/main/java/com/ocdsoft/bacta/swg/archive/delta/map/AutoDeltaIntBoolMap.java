...
public class AutoDeltaIntBoolMap extends AutoDeltaContainer {
    ...
    public void insert(final int key, final boolean value) {
        if (containsKey(key))
            return;
    ...
    private void onErase(final int key, final boolean value) {
        //callback
    }

    private void onInsert(final int key, final boolean value) {
        //callback
    }

    private void onSet(final int key, final boolean oldValue, final boolean newValue) {
        //callback
    }
    ...
    public static class Command implements ByteBufferWritable {
        ...
        public Command(int cmd, int key, boolean value) {
            this.cmd = (byte) cmd;
            this.key = key;
            this.value = value;
        }
