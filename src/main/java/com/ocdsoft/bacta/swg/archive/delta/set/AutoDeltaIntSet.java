...
public class AutoDeltaIntSet extends AutoDeltaContainer {
    ...
    public void erase(final int value) {
    ...
    private void onErase(final int value) {
        //implement on erase callback
    }

    private void onInsert(final int value) {
    ...
    public final class Command implements ByteBufferWritable {
        ...
        public Command(final byte cmd, final int value) {
            this.cmd = cmd;
            this.value = value;
        }
