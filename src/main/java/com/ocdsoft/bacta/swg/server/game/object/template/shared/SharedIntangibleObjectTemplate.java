...
public class SharedIntangibleObjectTemplate extends SharedObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(SharedIntangibleObjectTemplate.class);
	...
	public SharedIntangibleObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
