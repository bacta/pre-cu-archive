...
import com.ocdsoft.bacta.swg.server.game.message.object.command.Target;

@MessageHandled(handles = Target.class)
public class TargetCommandController implements CommandController<TangibleObject> {

	private static Logger LOGGER = LoggerFactory.getLogger(TargetCommandController.class);
