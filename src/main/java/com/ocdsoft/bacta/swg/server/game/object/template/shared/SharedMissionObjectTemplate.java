...
public class SharedMissionObjectTemplate extends SharedIntangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(SharedMissionObjectTemplate.class);
	...
	public SharedMissionObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
		super(filename, objectTemplateList);
	}

	@Override
	public int getId() {
		return TAG_SHAREDMISSIONOBJECTTEMPLATE;
	}

	@Override
	protected void load(final Iff iff) {
		if (iff.getCurrentName() != TAG_SHAREDMISSIONOBJECTTEMPLATE) {
			super.load(iff);
			return;
		}
