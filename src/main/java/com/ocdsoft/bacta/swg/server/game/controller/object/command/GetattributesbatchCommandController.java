...
import com.ocdsoft.bacta.swg.server.game.message.object.command.Getattributesbatch;

@MessageHandled(handles = Getattributesbatch.class)
public class GetattributesbatchCommandController implements CommandController<TangibleObject> {
