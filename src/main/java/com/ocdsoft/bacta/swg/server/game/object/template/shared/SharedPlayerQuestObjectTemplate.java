...
public class SharedPlayerQuestObjectTemplate extends SharedTangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(SharedPlayerQuestObjectTemplate.class);
	...
	public SharedPlayerQuestObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
