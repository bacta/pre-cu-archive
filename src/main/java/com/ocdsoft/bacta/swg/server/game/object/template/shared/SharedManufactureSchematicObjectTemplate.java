...
public class SharedManufactureSchematicObjectTemplate extends SharedIntangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(SharedManufactureSchematicObjectTemplate.class);
	...
	public SharedManufactureSchematicObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
		super(filename, objectTemplateList);
	}

	@Override
	public int getId() {
		return TAG_SHAREDMANUFACTURESCHEMATICOBJECTTEMPLATE;
	}
