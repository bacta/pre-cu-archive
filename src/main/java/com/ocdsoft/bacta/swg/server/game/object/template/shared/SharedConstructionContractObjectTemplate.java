...
public class SharedConstructionContractObjectTemplate extends SharedIntangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(SharedConstructionContractObjectTemplate.class);
	...
	public SharedConstructionContractObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
		super(filename, objectTemplateList);
	}

	@Override
	public int getId() {
		return TAG_SHAREDCONSTRUCTIONCONTRACTOBJECTTEMPLATE;
	}

	@Override
	protected void load(final Iff iff) {
		if (iff.getCurrentName() != TAG_SHAREDCONSTRUCTIONCONTRACTOBJECTTEMPLATE) {
			super.load(iff);
			return;
		}
