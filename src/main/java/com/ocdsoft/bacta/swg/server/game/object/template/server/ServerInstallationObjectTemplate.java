...
public class ServerInstallationObjectTemplate extends ServerTangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(ServerInstallationObjectTemplate.class);
	...
	public ServerInstallationObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
