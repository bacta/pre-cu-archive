...
public class ServerConstructionContractObjectTemplate extends ServerIntangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(ServerConstructionContractObjectTemplate.class);
	...
	public ServerConstructionContractObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
		super(filename, objectTemplateList);
	}

	@Override
	public int getId() {
		return TAG_SERVERCONSTRUCTIONCONTRACTOBJECTTEMPLATE;
	}

	@Override
	protected void load(final Iff iff) {
		if (iff.getCurrentName() != TAG_SERVERCONSTRUCTIONCONTRACTOBJECTTEMPLATE) {
			super.load(iff);
			return;
		}
