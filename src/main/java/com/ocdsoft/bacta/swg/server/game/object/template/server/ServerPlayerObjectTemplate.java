...
public class ServerPlayerObjectTemplate extends ServerIntangibleObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(ServerPlayerObjectTemplate.class);
	...
	public ServerPlayerObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
		super(filename, objectTemplateList);
	}

	@Override
	public int getId() {
		return TAG_SERVERPLAYEROBJECTTEMPLATE;
	}

	@Override
	protected void load(final Iff iff) {
		if (iff.getCurrentName() != TAG_SERVERPLAYEROBJECTTEMPLATE) {
			super.load(iff);
			return;
		}
