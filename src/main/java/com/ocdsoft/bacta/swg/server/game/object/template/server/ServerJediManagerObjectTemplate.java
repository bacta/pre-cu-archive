...
public class ServerJediManagerObjectTemplate extends ServerUniverseObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(ServerJediManagerObjectTemplate.class);
	...
	public ServerJediManagerObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
