...
public class ServerCellObjectTemplate extends ServerObjectTemplate {
	private static final Logger LOGGER = LoggerFactory.getLogger(ServerCellObjectTemplate.class);
	...
	public ServerCellObjectTemplate(final String filename, final DataResourceList<ObjectTemplate> objectTemplateList) {
