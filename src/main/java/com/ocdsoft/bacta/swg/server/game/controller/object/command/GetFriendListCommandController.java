 ...
 */
@QueuesCommand("getFriendList")
public final class GetFriendListCommandController implements CommandQueueController {
    ...
    @Inject
    public GetFriendListCommandController(final GameChatService chatService) {
    ...
    public void handleCommand(final SoeUdpConnection connection, final ServerObject actor, final ServerObject target, final String params) {
        ...
        this.chatService.getFriendList(player);
    }
}