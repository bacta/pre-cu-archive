...
public class StringUtil {
    ...
    /**
     * Attempts to get a null-terminated string from a {@link ByteBuffer}. This method starts from the buffers current
    ...
    /**
     * This function is used to parse a list of null terminated strings from a {@link ByteBuffer} when you don't know
     ...
     * were parsed from the ByteBuffer via {@link ArrayList#trimToSize()}.
     *
     * @param buffer The {@link ByteBuffer} containing the string data and advanced to the position of the first string.
