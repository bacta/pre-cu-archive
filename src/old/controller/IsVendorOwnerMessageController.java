...
import com.ocdsoft.bacta.swg.precu.message.IsVendorOwnerMessage;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@GameNetworkMessageHandled(server=ServerType.GAME, handles=IsVendorOwnerMessage.class)
public class IsVendorOwnerMessageController implements GameNetworkMessageController<GameClient> {
